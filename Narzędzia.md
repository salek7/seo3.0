...
| Narzędzie | Kategoria | Tydzień | Lekcja | Opis | Link |
| :-------- | :-------- | :------ | :----- | :--- | :--- |
| OpenRouter | Agregator API LLM | 2 | [Komunikacja z API](Materialy_z_lekcji/Tydzień_2_przygotowanie_do_pracy_z_modelami_językowymi/README.md#lekcja-komunikacja-z-api-modeli-językowych) | Serwis umożliwiający dostęp do ponad 300 modeli językowych od różnych dostawców (OpenAI, Anthropic, Google, Mistral itp.) poprzez ujednolicony interfejs API, często oferujący konkurencyjne ceny. Upraszcza integrację i zarządzanie dostępem do wielu LLM. | [OpenRouter](https://openrouter.ai/) |
| Google AI Studio | Interfejs Webowy / Platforma AI | 2 | [Komunikacja z API](Materialy_z_lekcji/Tydzień_2_przygotowanie_do_pracy_z_modelami_językowymi/README.md#lekcja-komunikacja-z-api-modeli-językowych) | Interfejs webowy od Google dla programistów, umożliwiający eksperymentowanie z modelami Gemini, tworzenie promptów i budowanie aplikacji opartych na AI. | [Google AI Studio](https://aistudio.google.com/) |
